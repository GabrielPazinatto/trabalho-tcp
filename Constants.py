...
INSTRUMENTS_DICT_FROM_CHAR: dict[str:int] = {
    "P" : INSTRUMENTS_VALUE.PIANO,
    "V" : INSTRUMENTS_VALUE.VIOLAO,
    "G" : INSTRUMENTS_VALUE.GUITARRA,
    "D" : INSTRUMENTS_VALUE.GUITARRA_DISTORCIDA,
    "B" : INSTRUMENTS_VALUE.BAIXO,
    "V" : INSTRUMENTS_VALUE.VIOLINO,
    "T" : INSTRUMENTS_VALUE.TROMPETE
}
